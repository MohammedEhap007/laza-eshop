...
ProductsItemModel _$ProductsItemModelFromJson(
  ...
  ($checkedConvert) {
    final val = ProductsItemModel(
      ...
      quantityInStock: $checkedConvert('stock', (v) => (v as num).toInt()),
      weight: $checkedConvert('weight', (v) => (v as num).toDouble()),
      color: $checkedConvert('color', (v) => v as String),
      rating: $checkedConvert('rating', (v) => (v as num).toInt()),
      reviewsCount: $checkedConvert('reviewsCount', (v) => (v as num).toInt()),
